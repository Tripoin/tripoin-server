...
public class UserEndpoint extends XReturnStatus {
    ...
    public Message<UserTransferObject> getAllUser(Message<?> inMessage) {
        ...
        try {
            ...
            LOGGER.error("User System Error : " + e.getLocalizedMessage(), e);
            userTransferObject.setResponseCode("1");
            userTransferObject.setResponseMsg(ParameterConstant.RESPONSE_FAILURE);
            userTransferObject.setResponseDesc("Availability System Error : " + e.getLocalizedMessage());
        }
