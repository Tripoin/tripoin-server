package com.tripoin.web.client.component;
...
public class ResetButtonForTextFieldConnector extends AbstractExtensionConnector implements KeyUpHandler, AttachEvent.Handler {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8164629496913049842L;
    ...
    protected void extend(ServerConnector serverConnector) {
        serverConnector
                .addStateChangeHandler(new StateChangeEvent.StateChangeHandler() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -6070253296336483339L;
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.tripoin.web.client.component.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
