package com.tripoin.web.client.samples;
...
import com.tripoin.web.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.tripoin.web.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
