...
import com.tripoin.web.component.ResetButtonForTextField;
...
public class SampleCrudView extends CssLayout implements View {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6879097886458165479L;
    ...
    public SampleCrudView() {
        ...
        grid.addSelectionListener(new SelectionListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1890169501652325983L;
    ...
    public HorizontalLayout createTopBar() {
        ...
        filter.addTextChangeListener(new FieldEvents.TextChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 1015502469780232527L;
        ...
        newProduct.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3150795192899274311L;
