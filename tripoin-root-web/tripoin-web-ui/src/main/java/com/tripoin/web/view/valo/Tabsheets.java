...
@Component
@Scope("prototype")
@VaadinView(value = "tabs", cached = true)
public class Tabsheets extends VerticalLayout implements View {

	private static final long serialVersionUID = -7814423245032034227L;
	TabSheet tabs;
    ...
    public Tabsheets() {
        ...
        ValueChangeListener update = new ValueChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2686365520164797146L;
    ...
    static TabSheet getTabSheet(boolean caption, String style,
        ...
        ts.addSelectedTabChangeListener(new SelectedTabChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -570372936438978861L;
