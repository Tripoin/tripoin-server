...
import com.tripoin.web.samples.backend.DataService;
import com.tripoin.web.samples.backend.data.Availability;
...
public class ProductForm extends ProductFormDesign {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6204609293581961530L;
	...
	public ProductForm(SampleCrudLogic sampleCrudLogic) {
        ...
        ValueChangeListener valueListener = new ValueChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8249603967757971377L;
        ...
        fieldGroup.addCommitHandler(new CommitHandler() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 8861146431394652447L;
        ...
        save.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5955311020954503951L;
        ...
        cancel.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -3952215811209013154L;
        ...
        delete.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5774182784796273417L;
