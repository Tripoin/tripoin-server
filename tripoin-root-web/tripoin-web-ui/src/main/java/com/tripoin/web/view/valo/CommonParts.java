...
public class CommonParts extends VerticalLayout implements View {
    ...
    Panel loadingIndicators() {
        ...
        loading.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 773219806268825133L;
        ...
        delay.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6403397725896795726L;
        ...
        wait.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7657493893012100975L;
    ...
    Panel notifications() {
        ...
        VerticalLayout content = new VerticalLayout() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -454589322448892674L;
            ...
            TextField delay = new TextField();
            {
                ...
                title.addValueChangeListener(new ValueChangeListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -2266245836445487176L;
                ...
                description.addValueChangeListener(new ValueChangeListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -2364231734144983141L;
                ...
                Command typeCommand = new Command() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 3659925520615705243L;
                ...
                Command styleCommand = new Command() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 5673445647114063516L;
                ...
                delay.addValueChangeListener(new ValueChangeListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -5106751178697716637L;
                ...
                Button clear = new Button(null, new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -1970499031125858776L;
                ...
                Button pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 6428225011104476974L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 7779810253133889952L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 6506874074181589974L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -3869900113393553450L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -8462129795087864025L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -4750193077725113168L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -1117276438371418244L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 4308234450230133493L;
                ...
                pos = new Button("", new ClickListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = -6113933326454288916L;
    ...
    Panel tooltips() {
        ...
        HorizontalLayout content = new HorizontalLayout() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 919638998555929275L;
    ...
    Panel windows() {
        ...
        VerticalLayout content = new VerticalLayout() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6926990372384208182L;
            ...
            VerticalLayout windowContent() {
                ...
                if (tabsVisible) {
                    ...
                    tabs.addSelectedTabChangeListener(new SelectedTabChangeListener() {
						 ...
						 * 
						 */
						private static final long serialVersionUID = 8348713798011294530L;
...

            {
                ...
                Command optionsCommand = new Command() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 2998079871806594253L;
                ...
                Command optionsCommand2 = new Command() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 2083903388003519956L;
                ...
                final Button show = new Button("Open Window",
                        new ClickListener() {
							 ...
							 * 
							 */
							private static final long serialVersionUID = -5932911364937198623L;
                ...
                hidden.addValueChangeListener(new ValueChangeListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 4988813671440328821L;
                ...
                win.addCloseListener(new CloseListener() {
					 ...
					 * 
					 */
					private static final long serialVersionUID = 5902754098243024928L;
