...
public class ProductGrid extends Grid {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8930242006922159764L;
	private StringToEnumConverter availabilityConverter = new StringToEnumConverter() {
        /**
		 * 
		 */
		private static final long serialVersionUID = -3751560683044280279L;
    ...
    public ProductGrid() {
        ...
        getColumn("stockCount").setConverter(new StringToIntegerConverter() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 5181302857632594423L;
        ...
        setCellStyleGenerator(new CellStyleGenerator() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 530769726438594172L;
