...
@Component
@Scope("prototype")
@VaadinView(value = "menubars", cached = true)
public class MenuBars extends VerticalLayout implements View {

	private static final long serialVersionUID = 5733410246537299024L;
    ...
    static MenuBar getMenuBar() {
        ...
        Command check = new Command() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 4977856568186843752L;
        ...
        BaseIcon baseIcon = new BaseIcon(50);

        MenuItem fav = menubar.addItem("", check);
        fav.setIcon(baseIcon.get());
